<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DisplayDoctordetails_R.aspx.cs" Inherits="Diagnostic_medicare_center__management.DisplayDoctordetails_R" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <br />
     <asp:GridView runat="server" ID="gdvDoctorDetails_r"
